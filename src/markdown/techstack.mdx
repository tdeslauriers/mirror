...
application written in TypeScript using NextJS's App Router pattern.  
In short, this is the part of the application that you can see and interact with directly.
...
need to get service credentials before taking any other action, the ignite side of the dragon pair
seemed appropriate.
