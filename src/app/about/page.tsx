    ...
    <>
      <main className={`main ${hasIdentity ? "main-drawer" : null}`}>
        ...
        <div className={`content`}>
          <p>
            I wanted a place to host pictures of/for my family and friends since
            I don&apos;t post photos of us on social media generally. Over the
            years, the site has become my Frankenstein&apos;s monster or as a
            friend said,{" "}
